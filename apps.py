...
# # Example 1: Two Autobots Want the Same Spot
# grid_size = (5, 5)
# obstacles = [(2, 2)]

# autobots = [
#     Autobot("A", (0, 0), (3, 3), grid_size, obstacles),
#     Autobot("B", (0, 4), (3, 3), grid_size, obstacles),
# ]
...
# Example 4: for each autobot the other autobots are the moving obstacals

# #Example 5. Long, Winding Road + prev all follows
# grid_size = (10, 5)
# obstacles = [(1, 1), (3, 2), (5, 4), (7, 1), (8, 3), (9, 3)]
#
# autobots = [
#     Autobot("A", (0, 0), (9, 4), grid_size, obstacles),
#     Autobot("B", (0, 4), (9, 0), grid_size, obstacles),
#     Autobot("C", (0, 2), (9, 2), grid_size, obstacles),
# ]

# Example 6: Tight Corridor + Example 7: Two Autobots one path
# grid_size = (5, 5)
# obstacles = [(0, 3), (1, 1), (0, 1), (3, 1), (4, 1)]
# autobots = [
#     Autobot("A", (0, 0), (3, 4), grid_size, obstacles),
#     Autobot("B", (4, 0), (3, 2), grid_size, obstacles),
#     Autobot("C", (2, 0), (3, 2), grid_size, obstacles),
# ]

# Example 8: Dead-End
# grid_size = (5, 5)
# obstacles = [
#     (1, 1), (1, 2), (1, 3),  # Block upper row, creating dead-end paths
#     (3, 1), (3, 2), (3, 3),  # Block lower row
#     (2, 3), (4, 1), (4, 2), (4, 3)  # Block access to the goal
# ]
#
# autobots = [
#     Autobot("A", (0, 0), (3, 0), grid_size, obstacles),
#     Autobot("B", (2, 2), (4, 4), grid_size, obstacles),
# ]

# Example Usecase - 9
# grid_size = (13, 13)
#
# # Adding more obstacles to make the grid crowded
# obstacles = [
#     (1, 3), (2, 2), (2, 3), (2, 4), (4, 7), (5, 7),
#     (6, 7), (6, 8), (6, 9), (6, 10), (9, 3), (10, 3),
#     (11, 3), (11, 5), (12, 12),
#     (0, 6), (1, 6), (2, 6), (3, 6),
#     (4, 4), (4, 5),
#     (7, 4), (8, 4), (9, 4),
...
#
# autobots = [
#     Autobot("A", (0, 0), (3, 10), grid_size, obstacles),
#     Autobot("B", (1, 12), (5, 5), grid_size, obstacles),
#     Autobot("C", (2, 5), (9, 9), grid_size, obstacles),
#     Autobot("D", (3, 0), (7, 11), grid_size, obstacles),
#     Autobot("E", (5, 2), (12, 8), grid_size, obstacles),
#     Autobot("F", (6, 6), (0, 12), grid_size, obstacles),
#     Autobot("G", (10, 0), (11, 11), grid_size, obstacles),
# ]

# Example 10: We have the priority according to the longest path to reduce the system time

# Example 11: Circling (Loop): in example 8 A is follow the cycle path due to heavy crowred but dosenot get dizzy
